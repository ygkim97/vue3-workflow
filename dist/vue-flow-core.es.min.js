...
const edges = [{ "id": "e1-2", "type": "custom", "source": "test1", "target": "test2", "data": { "test": "test edge data" }, "label": "Label", "labelStyle": {}, "labelBgStyle": {}, "labelBgPadding": [0, 0], "labelBgBorderRadius": 0, "style": {} }, { "id": "e2-4", "type": "custom", "source": "test2", "target": "test4", "data": {} }];
const GraphData1 = {
  nodes,
  edges
};
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return props.useControl ? (openBlock(), createBlock(unref(_sfc_main$6), {
        key: 0,
        ...
        default: withCtx(() => [
          props.controlShowUndoRedo ? (openBlock(), createBlock(unref(ControlButton), {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$5, { name: "arrow-rotate-left" })
            ]),
            _: 1
          ...
          props.controlShowUndoRedo ? (openBlock(), createBlock(unref(ControlButton), {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$5, { name: "arrow-rotate-right" })
            ]),
            _: 1
          }, 8, ["disabled"])) : createCommentVNode("", true),
          props.controlShowScreenShot ? (openBlock(), createBlock(unref(ControlButton), {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$5, { name: "camera" })
            ]),
            _: 1
          })) : createCommentVNode("", true),
          props.controlShowSave ? (openBlock(), createBlock(unref(ControlButton), {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$5, { name: "floppy-disk" })
            ]),
            _: 1
          })) : createCommentVNode("", true),
          props.controlShowExecution ? (openBlock(), createBlock(unref(ControlButton), {
            ...
            default: withCtx(() => [
              createVNode(_sfc_main$5, { name: "play" })
            ]),
            _: 1
          })) : createCommentVNode("", true),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isSelected = computed(() => {
      ...
      return (node == null ? void 0 : node.selected) ?? false;
    });
    const nodeLabel = computed(() => {
      var _a2;
      return (_a2 = props.data) == null ? void 0 : _a2[props.nodeLabelKey];
    });
    const selectedNode = findNode(props.id);
    const nodeType = ref(((_a = props.data) == null ? void 0 : _a[props.nodeTypeKey]) || "default");
    const createNode = () => {
    ...
    const editNode = () => {
      ...
      emit("editNode", transformNodeData(node));
    };
    const copyNode = () => {
      if (!selectedNode) return;
      const node = {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(_sfc_main$3), {
          ...
          default: withCtx(() => [
            props.nodeToolbarShowAdd ? (openBlock(), createElementBlock("button", {
              ...
              createVNode(_sfc_main$5, { name: "plus" })
            ])) : createCommentVNode("", true),
            props.nodeToolbarShowDelete ? (openBlock(), createElementBlock("button", {
              ...
              createVNode(_sfc_main$5, { name: "trash" })
            ])) : createCommentVNode("", true),
            props.nodeToolbarShowEdit ? (openBlock(), createElementBlock("button", {
              ...
              createVNode(_sfc_main$5, { name: "pen-to-square" })
            ])) : createCommentVNode("", true),
            props.nodeToolbarShowCopy ? (openBlock(), createElementBlock("button", {
              ...
              createVNode(_sfc_main$5, { name: "copy" })
            ])) : createCommentVNode("", true),
        ...
        createElementVNode("div", {
          style: normalizeStyle([props.defaultNodeStyle, isSelected.value ? props.selectNodeStyle : {}]),
          class: normalizeClass([`vue-flow__node-${nodeType.value}`, props.defaultNodeClass, isSelected.value ? props.selectNodeClass : ""])
        }, [
          nodeType.value !== "input" ? (openBlock(), createBlock(unref(_sfc_main$f), {
            key: 0,
            type: "target",
            position: unref(Position).Left,
            style: normalizeStyle(props.defaultHandleStyle),
            class: normalizeClass(__props.defaultHandleClass)
          }, null, 8, ["position", "style", "class"])) : createCommentVNode("", true),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(edgeComponents[props.edgeType] || unref(BezierEdge$1)), {
        id: __props.id,
        style: normalizeStyle([props.defaultEdgeStyle, isSelected.value ? props.selectEdgeStyle : {}]),
        class: normalizeClass([props.defaultEdgeClass, isSelected.value ? props.selectEdgeClass : {}]),
      ...
      }, null, 8, ["id", "style", "class", "source-x", "source-y", "target-x", "target-y", "source-position", "target-position"]);
    };
  }
});
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const changeEdgeAnimated = (edgeIds) => {
      const addAnimatedEdgeIds = edgeIds.filter((id2) => !animatedEdgeIds.includes(id2));
      const deleteAnimatedEdgeIds = animatedEdgeIds.filter((id2) => !edgeIds.includes(id2));
      animatedEdgeIds = [...edgeIds];
      setEdgeAnimated({ addList: addAnimatedEdgeIds, deleteList: deleteAnimatedEdgeIds });
    };
    const setEdgeAnimated = ({ addList, deleteList }) => {
      addList.forEach((id2) => {
        const edge = findEdge(id2);
        if (edge) edge.animated = true;
      });
      deleteList.forEach((id2) => {
        const edge = findEdge(id2);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$1$3), {
        ...
        "node-custom": withCtx((customNodeProps) => [
          ...
          }, null, 8, ["id", "data", "node-label-key", "node-type-key", "default-node-style", "default-node-class", "default-handle-style", "default-handle-class", "select-node-style", "select-node-class", "use-node-toolbar", "node-toolbar-position", "node-toolbar-offset", "node-toolbar-show-add", "node-toolbar-show-delete", "node-toolbar-show-edit", "node-toolbar-show-copy", "node-toolbar-show-execution"])
        ]),
        "edge-custom": withCtx((customEdgeProps) => [
          ...
          }), null, 16, ["id", "source-x", "source-y", "target-x", "target-y", "source-position", "target-position", "label", "labelBgBorderRadius", "labelBgPadding", "labelBgStyle", "labelStyle", "edge-type", "default-edge-style", "default-edge-class", "select-edge-style", "select-edge-class", "marker-type"])
        ]),
        default: withCtx(() => [
