...
const state$1 = {
  snapGrid: ref([15, 15]),
  dragStartPositionMap: ref({}),
  historyStack: ref({}),
  currentStackKey: ref({})
};
function useFlowCommon() {
  const { snapGrid, dragStartPositionMap, historyStack, currentStackKey } = state$1;
  const {
    id: id2,
    getSelectedNodes,
    getSelectedEdges,
  ...
  const isUndoDisabled = computed(() => {
    return currentStackKey.value[id2] === 0;
  });
  const isRedoDisabled = computed(() => {
    var _a;
    return ((_a = historyStack.value[id2]) == null ? void 0 : _a.length) === currentStackKey.value[id2] + 1;
  });
  const setSnapGrid = (data) => {
    snapGrid.value = data;
  };
  const initHistoryStack = ({ nodes: nodes2, edges: edges2 }) => {
    historyStack.value[id2] = [{ actionType: "init", nodes: nodes2, edges: edges2 }];
    currentStackKey.value[id2] = 0;
  };
  ...
  const updateNodeData = (node, shouldPushHistory) => {
    const originNodeData = { class: "", ...findNode(node.id) };
  ...
  const updateEdge = (edge) => {
    const updateEdgeData2 = { ...findEdge(edge.id), ...edge };
    removeEdges(edge.id);
    addEdges(updateEdgeData2);
  };
  const updateEdgeData = (edge, shouldPushHistory) => {
    const originEdgeData = findEdge(edge.id);
    updateEdge(edge);
    if (shouldPushHistory) {
  ...
  const onNodeDragStart = ({ nodes: nodes2 }) => {
    nodes2.forEach(({ id: id22 }) => {
      const { position } = { ...findNode(id22) };
      dragStartPositionMap.value[id22] = { x: position.x, y: position.y };
    });
  };
  ...
  const resetNodePositionIfOccupied = (nodes2) => {
    ...
    const originNodePositionList = nodes2.map(({ id: id22, position }) => {
      changeNodePositionList.push({ id: id22, position });
      const originPosition = { position: dragStartPositionMap.value[id22] };
      if (isNodePositionOccupied) {
        updateNode(id22, originPosition);
      }
      return { id: id22, ...originPosition };
    });
    if (!isNodePositionOccupied) {
  ...
  const pushHistory = (history) => {
    currentStackKey.value[id2]++;
    if (historyStack.value[currentStackKey.value[id2]]) {
      historyStack.value[id2].splice(currentStackKey.value[id2]);
    }
    historyStack.value[id2].push(history);
  };
  const executeUndo = () => {
    if (currentStackKey.value[id2] === 0) {
      return;
    }
    const { actionType, nodes: nodes2, edges: edges2, origin } = historyStack.value[id2][currentStackKey.value[id2]--];
  ...
  const executeRedo = () => {
    if (historyStack.value[id2].length === currentStackKey.value[id2] + 1) {
      return;
    }
    const { actionType, nodes: nodes2, edges: edges2, change } = historyStack.value[id2][++currentStackKey.value[id2]];
...
function requireDomToImageMore_min() {
  ...
  (function(module, exports) {
    ((l) => {
      let f = /* @__PURE__ */ (() => {
        ...
        function i2(t3, n3) {
          if (t3.nodeType === m) {
            let e3 = h2(t3).getPropertyValue(n3);
      ...
      let s = { copyDefaultStyles: true, imagePlaceholder: void 0, cacheBust: false, useCredentials: false, useCredentialsFilters: [], httpTimeout: 3e4, styleCaching: "strict", corsImg: void 0 }, d = { toSvg: a, toPng: function(e2, t2) {
      ...
      }, toCanvas: i, impl: { fontFaces: e, images: n, util: f, inliner: r, urlCache: [], options: {} } }, m = (module.exports = d, ("undefined" != typeof Node ? Node.ELEMENT_NODE : void 0) || 1), h2 = (void 0 !== l ? l.getComputedStyle : void 0) || ("undefined" != typeof window ? window.getComputedStyle : void 0) || globalThis.getComputedStyle, u = (void 0 !== l ? l.atob : void 0) || ("undefined" != typeof window ? window.atob : void 0) || globalThis.atob;
      function a(e2, r2) {
        d.impl.util.getWindow(e2);
        var n2 = r2 = r2 || {};
        ...
        return Promise.resolve(e2).then(function(e3) {
          ...
          var t2 = e3, n3 = e3.parentNode, o2 = document.createElement("span");
          return n3.replaceChild(o2, t2), o2.append(e3), i2.push({ parent: n3, child: t2, wrapper: o2 }), o2;
        }).then(function(e3) {
          return function l2(t2, s2, r3, u2) {
            let e4 = s2.filter;
            if (t2 === p || f.isHTMLScriptElement(t2) || f.isHTMLStyleElement(t2) || f.isHTMLLinkElement(t2) || null !== r3 && e4 && !e4(t2)) return Promise.resolve();
            return Promise.resolve(t2).then(n3).then(o2).then(function(e5) {
              return c2(e5, a2(t2));
            ...
            function o2(e5) {
              return s2.adjustClonedNode && s2.adjustClonedNode(t2, e5, false), Promise.resolve(e5);
            }
            function i3(e5) {
              return s2.adjustClonedNode && s2.adjustClonedNode(t2, e5, true), Promise.resolve(e5);
            }
            function a2(e5) {
              return f.isElementHostForOpenShadowRoot(e5) ? e5.shadowRoot : e5;
            }
            function c2(n4, e5) {
              let o3 = t3(e5), r4 = Promise.resolve();
              if (0 !== o3.length) {
                let t4 = h2(i4(e5));
                f.asArray(o3).forEach(function(e6) {
                  r4 = r4.then(function() {
                    return l2(e6, s2, t4).then(function(e7) {
              ...
              function t3(t4) {
                if (f.isShadowSlotElement(t4)) {
                  let e6 = t4.assignedNodes();
            ...
            function d2(u3, a3) {
              return !f.isElement(u3) || f.isShadowSlotElement(a3) ? Promise.resolve(u3) : Promise.resolve().then(e5).then(t3).then(n4).then(o3).then(function() {
                return u3;
              });
              function e5() {
                function o4(e7, t4) {
                  t4.font = e7.font, t4.fontFamily = e7.fontFamily, t4.fontFeatureSettings = e7.fontFeatureSettings, t4.fontKerning = e7.fontKerning, t4.fontSize = e7.fontSize, t4.fontStretch = e7.fontStretch, t4.fontStyle = e7.fontStyle, t4.fontVariant = e7.fontVariant, t4.fontVariantCaps = e7.fontVariantCaps, t4.fontVariantEastAsian = e7.fontVariantEastAsian, t4.fontVariantLigatures = e7.fontVariantLigatures, t4.fontVariantNumeric = e7.fontVariantNumeric, t4.fontVariationSettings = e7.fontVariationSettings, t4.fontWeight = e7.fontWeight;
                }
                function e6(e7, t4) {
                  let n5 = h2(e7);
                  n5.cssText ? (t4.style.cssText = n5.cssText, o4(n5, t4.style)) : (y(s2, e7, n5, r3, t4), null === r3 && (["inset-block", "inset-block-start", "inset-block-end"].forEach((e8) => t4.style.removeProperty(e8)), ["left", "right", "top", "bottom"].forEach((e8) => {
                    t4.style.getPropertyValue(e8) && t4.style.setProperty(e8, "0px");
                  })));
                }
                e6(a3, u3);
              }
              function t3() {
                let s3 = f.uid();
                function t4(r4) {
                  let i4 = h2(a3, r4), l3 = i4.getPropertyValue("content");
                  if ("" !== l3 && "none" !== l3) {
                    let n5 = function() {
                      let e7 = `.${s3}:` + r4, t6 = (i4.cssText ? n6 : o4)();
                      return document.createTextNode(e7 + `{${t6}}`);
                      function n6() {
                        return `${i4.cssText} content: ${l3};`;
                      }
                      function o4() {
                        let e8 = f.asArray(i4).map(t7).join("; ");
                        return e8 + ";";
                        function t7(e9) {
                          let t8 = i4.getPropertyValue(e9), n7 = i4.getPropertyPriority(e9) ? " !important" : "";
                          return e9 + ": " + t8 + n7;
                        }
                      }
                    };
                    let e6 = u3.getAttribute("class") || "", t5 = (u3.setAttribute("class", e6 + " " + s3), document.createElement("style"));
                    t5.appendChild(n5()), u3.appendChild(t5);
                  }
                }
              ...
              function o3() {
                f.isSVGElement(u3) && (u3.setAttribute("xmlns", "http://www.w3.org/2000/svg"), f.isSVGRectElement(u3)) && ["width", "height"].forEach(function(e6) {
                  let t4 = u3.getAttribute(e6);
                  t4 && u3.style.setProperty(e6, t4);
                });
              }
            }
          }(e3, r2, null);
        }).then(r2.disableEmbedFonts ? Promise.resolve(e2) : c).then(g).then(function(t2) {
          r2.bgcolor && (t2.style.backgroundColor = r2.bgcolor);
          r2.width && (t2.style.width = r2.width + "px");
          r2.height && (t2.style.height = r2.height + "px");
          r2.style && Object.keys(r2.style).forEach(function(e4) {
            t2.style[e4] = r2.style[e4];
          });
          let e3 = null;
          "function" == typeof r2.onclone && (e3 = r2.onclone(t2));
          ...
          return Promise.resolve(e3).then(function(e4) {
            ...
            var t2 = (f.isDimensionMissing(n3) ? ' width="100%"' : ` width="${n3}"`) + (f.isDimensionMissing(o2) ? ' height="100%"' : ` height="${o2}"`);
            return `<svg xmlns="http://www.w3.org/2000/svg"${(f.isDimensionMissing(n3) ? "" : ` width="${n3}"`) + (f.isDimensionMissing(o2) ? "" : ` height="${o2}"`)}><foreignObject${t2}>${e4}</foreignObject></svg>`;
          }).then(function(e4) {
          ...
          for (; 0 < i2.length; ) {
            var t2 = i2.pop();
            t2.parent.replaceChild(t2.child, t2.wrapper);
          }
          return e3;
        }).then(function(e3) {
  ...
  })(domToImageMore_min$1);
  return domToImageMore_min$1.exports;
}
var domToImageMore_minExports = requireDomToImageMore_min();
const domtoimage = /* @__PURE__ */ getDefaultExportFromCjs(domToImageMore_minExports);
function useScreenshot() {
  ...
  const convertToImage = async (el, options) => {
    switch (options.type) {
      case "jpeg":
  ...
  const toJpeg = (el, options) => {
    error.value = null;
    return domtoimage.toJPeg(el, options).then((data) => {
      dataUrl.value = data;
      imgType.value = "jpeg";
      return data;
    }).catch((error2) => {
  ...
  const toPng = (el, options) => {
    error.value = null;
    return domtoimage.toPng(el, options).then((data) => {
      dataUrl.value = data;
      imgType.value = "png";
      return data;
    }).catch((error2) => {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const screenShotBtnClick = async () => {
      ...
      await nextTick();
      capture(vueFlowRef.value, { shouldDownload: true, isNodeDataOnly: true });
    };
    const saveBtnClick = () => {
      const params = {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const { addNode, deleteElements, findAvailablePosition, transformNodeData, transformEdgeData, getPathByNodeId } = useFlowCommon();
    const props = __props;
    const emit = __emit;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createElementVNode("div", { title: nodeLabel.value }, toDisplayString(nodeLabel.value), 9, _hoisted_1),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["save", "executeAll", "switchTheme", "addNode", "deleteNode", "editNode", "copyNode", "execute", "deleteFlow", "draggingOver", "nodeClick", "edgeClick", "paneClick", "selectFlow"],
  setup(__props, { expose: __expose, emit: __emit }) {
    const { findNode, findEdge, getSelectedNodes, getSelectedEdges, getNodes, getEdges, getIncomers: getIncomers2, getOutgoers: getOutgoers2 } = useVueFlow();
    const {
      setSnapGrid,
      initHistoryStack,
      deleteElements,
    ...
    watch(
      ...
      ({ nodes: nodes2, edges: edges2 }) => {
        initHistoryStack({ nodes: nodes2, edges: edges2 });
      },
      { deep: true }
    );
    ...
    const changeNode = (node, shouldPushHistory = false) => {
      updateNodeData(node, shouldPushHistory);
    };
    const changeEdge = (edge, shouldPushHistory = false) => {
    ...
    __expose({
      ...
      getPathByNodeId,
      getIncomers(id2) {
        const node = getIncomers2(id2);
        return transformNodeData(node);
      },
      getOutgoers(id2) {
        const node = getOutgoers2(id2);
        return transformNodeData(node);
      }
    });
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$1$3), {
        ...
        onConnect,
        onNodeDragStart: unref(onNodeDragStart),
        ...
        onEdgeClick,
        onKeyup,
        onPaneClick: _cache[8] || (_cache[8] = ($event) => _ctx.$emit("paneClick"))
      }, {
        ...
        _: 1
      }, 8, ["nodes", "edges", "nodes-connectable", "elements-selectable", "fit-view-on-init", "min-zoom", "max-zoom", "snap-grid", "onNodeDragStart", "onNodeDragStop", "onDragover", "onDragleave", "onDrop"]);
    };
  }
});
export {
